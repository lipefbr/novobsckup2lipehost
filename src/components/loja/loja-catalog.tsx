        ...
        <div className="container-x relative">
          <Reveal direction="up">
            ...
            <p className="mt-5 text-base text-white/60 max-w-2xl">
              Mais de 12 sistemas desenvolvidos pela LIPE.HOST, testados e em produção. Escolha o
              sistema ideal para o seu negócio e entre em operação em semanas.
            </p>
          </Reveal>
        ...
        <div className="container-x">
          ...
          {filtered.length === 0 ? (
            <div className="text-center py-24">
              ...
              <h2 className="text-xl font-bold mb-2">Nenhum sistema encontrado</h2>
          ...
          <Reveal className="relative rounded-2xl border border-white/10 bg-[#0c0c0c] p-8 sm:p-12 text-center overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-sm text-white/60 max-w-lg mx-auto mb-7">
                A LIPE.HOST desenvolve qualquer sistema sob medida para sua empresa. Conte sua ideia
                e cuidamos do resto.
              </p>
              <Link
                href="/#contato"
